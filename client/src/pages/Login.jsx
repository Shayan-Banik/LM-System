...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.error(error);
      toast.error(
        error.response?.data?.message || "Error login up. Please try again.",
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="md:w-[50%] w-full h-full flex flex-col justify-center items-center gap-4 bg-white">
          ...
          <div className="w-[80%] px-3">
            ...
            <span
              ...
              className="text-[#999797] text-[12px] flex justify-center cursor-pointer pt-1">
          ...
          <div className="w-[80%] px-3">
            <button
              ...
              className="w-full bg-white  border border-[#999797] text-red-500 px-5 py-2 rounded-md">
              Google
            </button>
          </div>
